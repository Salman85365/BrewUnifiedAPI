...
from .views import WarehouseItemList, WarehouseItemPrice, WarehouseItemBuy, \
    CreateDummyDataWarehouse
...
urlpatterns = [
    ...
    path('items/<int:item_id>/buy/', WarehouseItemBuy.as_view(),
         name='item-buy'),
    path('items/create-dummy-data/', CreateDummyDataWarehouse.as_view(),
